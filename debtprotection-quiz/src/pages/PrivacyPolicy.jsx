      ...
      <div className="container-narrow">
        <section className="card p-6 sm:p-8 max-w-3xl mx-auto">
          ...
          <ul className="list-disc ml-6 space-y-1">
            <li>
              Personal information (name, email, phone number, etc.) you provide
              through forms or quizzes.
            </li>
            <li>
          ...
          <p>
            ...
            providers assisting with our operations. We do not sell your
          ...
          <h2 className="text-xl font-bold mt-6 mb-2">6. Cookies</h2>
          <p>
            We may use cookies and tracking tools to enhance your experience.
